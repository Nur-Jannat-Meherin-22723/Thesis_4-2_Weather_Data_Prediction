...
input_file = r"E:\Thesis\Max Temp\41909\svr_max_temp_41909\2d_ssa_reconstructed_41909_max_temp.xlsx"
output_file = os.path.join(os.path.dirname(input_file), "normalized_max_temp_station_41909.xlsx")
