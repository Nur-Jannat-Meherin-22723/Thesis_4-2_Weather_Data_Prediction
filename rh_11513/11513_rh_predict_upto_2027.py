...
# Load dataset
file_path = r"E:\Thesis\Web App\relative_humidity\rh_11513\2d_ssa_reconstructed_11513_rh.xlsx"
...
for year in predicted_years:
    for month in predicted_months:
        ...
        # Store prediction
        predictions.append([11513, year, month] + predicted_days)  
...
# Safe file-saving
output_path = r"E:\Thesis\Web App\relative_humidity\rh_11513\predicted_rh_11513.xlsx"
