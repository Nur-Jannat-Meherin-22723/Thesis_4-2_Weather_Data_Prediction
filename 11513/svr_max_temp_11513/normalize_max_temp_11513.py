...
input_file = r"E:\Thesis\Max Temp\11513\svr_max_temp_11513\2d_ssa_reconstructed_11513_max_temp.xlsx"
output_file = os.path.join(os.path.dirname(input_file), "normalized_max_temp_station_11513.xlsx")
