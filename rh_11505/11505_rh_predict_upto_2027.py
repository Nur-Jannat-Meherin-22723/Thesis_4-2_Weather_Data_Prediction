...
# Load dataset
file_path = r"E:\Thesis\Web App\relative_humidity\rh_11505\2d_ssa_reconstructed_11505_rh.xlsx"
...
for year in predicted_years:
    for month in predicted_months:
        ...
        # Store prediction
        predictions.append([11505, year, month] + predicted_days)  
...
# Safe file-saving
output_path = r"E:\Thesis\Web App\relative_humidity\rh_11505\predicted_rh_11505.xlsx"
