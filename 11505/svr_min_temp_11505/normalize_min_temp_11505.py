...
input_file = r"E:\Thesis\Min Temp\11505\svr_min_temp_11505\2d_ssa_reconstructed_11505_min_temp.xlsx"
output_file = os.path.join(os.path.dirname(input_file), "normalized_min_temp_station_11505.xlsx")
