...
input_file = r"E:\Thesis\Min Temp\11513\svr_min_temp_11513\2d_ssa_reconstructed_11513_min_temp.xlsx"
output_file = os.path.join(os.path.dirname(input_file), "normalized_min_temp_station_11513.xlsx")
