...
input_file = r"E:\Thesis\Rainfall\11505\svr_rainfall_11505\2d_ssa_reconstructed_11505_rainfall.xlsx"
output_file = os.path.join(os.path.dirname(input_file), "normalized_rainfall_station_11505.xlsx")
