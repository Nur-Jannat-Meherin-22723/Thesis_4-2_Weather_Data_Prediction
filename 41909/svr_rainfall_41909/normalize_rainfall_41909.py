...
input_file = r"E:\Thesis\Rainfall\41909\svr_rainfall_41909\2d_ssa_reconstructed_41909_rainfall.xlsx"
output_file = os.path.join(os.path.dirname(input_file), "normalized_rainfall_station_41909.xlsx")
