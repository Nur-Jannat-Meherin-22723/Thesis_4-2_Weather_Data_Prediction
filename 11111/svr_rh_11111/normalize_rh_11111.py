...
input_file = r"E:\Thesis\Relative Humidity\11111\svr_rh_11111\2d_ssa_reconstructed_11111_rh.xlsx"
output_file = os.path.join(os.path.dirname(input_file), "normalized_rh_station_11111.xlsx")
