...
* Then SVR is implemented using this split (svr_max_temp_11505.py and svr_prediction_max_temp_11505 folder for output data). Shows prediction od the test folds data and performance parameters MSE, MAE, RMSE, R^2.
