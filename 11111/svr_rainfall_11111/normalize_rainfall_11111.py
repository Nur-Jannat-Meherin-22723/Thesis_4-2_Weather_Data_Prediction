...
input_file = r"E:\Thesis\Rainfall\11111\svr_rainfall_11111\2d_ssa_reconstructed_11111_rainfall.xlsx"
output_file = os.path.join(os.path.dirname(input_file), "normalized_rainfall_station_11111.xlsx")
