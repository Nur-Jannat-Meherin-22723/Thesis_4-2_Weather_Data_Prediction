...
file_path = r"E:\Thesis\Web App\min_temp\min_temp_11505\2d_ssa_reconstructed_11505_min_temp.xlsx"
...
# Filter data to ensure correct training range (Jan 1948 - May 2021)
df_train = df[(df['Year'] > 1947) & ((df['Year'] < 2021) | ((df['Year'] == 2021) & (df['Month'] <= 5)))]  # 1948 - May 2021
...
for year in predicted_years:
    for month in predicted_months:
        ...
        # Store prediction
        predictions.append([11505, year, month] + predicted_days)  # Fixed station index
...
# Safe file-saving
output_path = r"E:\Thesis\Web App\min_temp\min_temp_11505\predicted_2d_min_temp_11505.xlsx"
