...
# Load dataset
file_path = r"E:\Thesis\Web App\relative_humidity\rh_11111\2d_ssa_reconstructed_11111_rh.xlsx"
...
# 🔹 **Fix: Correct the training range (Jan 1953 - Aug 2021)**
df_train = df[(df['Year'] > 1952) & ((df['Year'] < 2021) | ((df['Year'] == 2021) & (df['Month'] <= 8)))]  
...
# Safe file-saving
output_path = r"E:\Thesis\Web App\relative_humidity\rh_11111\predicted_rh_11111.xlsx"
