...
input_file = r"E:\Thesis\Min Temp\41909\svr_min_temp_41909\2d_ssa_reconstructed_41909_min_temp.xlsx"
output_file = os.path.join(os.path.dirname(input_file), "normalized_min_temp_station_41909.xlsx")
