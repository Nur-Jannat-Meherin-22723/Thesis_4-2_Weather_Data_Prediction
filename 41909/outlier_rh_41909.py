...
input_file = r"E:\Thesis\Relative Humidity\41909\rh_station_41909.xlsx"
output_file = os.path.join(os.path.dirname(input_file), "outlier_processed_rh_station_41909.xlsx")
