...
input_file = r"E:\Thesis\Relative Humidity\41909\svr_rh_41909\2d_ssa_reconstructed_41909_rh.xlsx"
output_file = os.path.join(os.path.dirname(input_file), "normalized_rh_station_41909.xlsx")
