...
input_file = r"E:\Thesis\Rainfall\11513\svr_rainfall_11513\2d_ssa_reconstructed_11513_rainfall.xlsx"
output_file = os.path.join(os.path.dirname(input_file), "normalized_rainfall_station_11513.xlsx")
