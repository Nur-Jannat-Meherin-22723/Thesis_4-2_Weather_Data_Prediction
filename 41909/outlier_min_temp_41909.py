...
input_file = r"E:\Thesis\Min Temp\41909\min_temp_station_41909.xlsx"
output_file = os.path.join(os.path.dirname(input_file), "outlier_processed_min_temp_station_41909.xlsx")
