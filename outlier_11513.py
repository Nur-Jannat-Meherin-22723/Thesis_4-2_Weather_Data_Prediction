...
input_file = r"D:\\4-1\\4-2\\Thesis\\code\\DataPreprocessing\\DataPreprocessing\\max_temp_station_41909.xlsx"
output_file = os.path.join(os.path.dirname(input_file), "outlier_processed_max_temp_station_11513.xlsx")
