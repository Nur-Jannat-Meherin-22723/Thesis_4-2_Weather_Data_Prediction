...
file_path = r"E:\Thesis\Web App\max_temp\11513_max_temp\2d_ssa_reconstructed_11513_max_temp.xlsx"
...
df_train = df[(df['Year'] < 2021) | ((df['Year'] == 2021) & (df['Month'] <= 5))]
...
# Safe file-saving
output_path = r"E:\Thesis\Web App\max_temp\11513_max_temp\predicted_2d_max_temp_11513.xlsx"
