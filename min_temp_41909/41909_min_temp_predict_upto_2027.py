...
file_path = r"E:\Thesis\Web App\min_temp\min_temp_41909\2d_ssa_reconstructed_41909_min_temp.xlsx"
...
# Filter data to ensure correct training range (Apr 1987 - May 2021)
df_train = df[(df['Year'] > 1986) & ((df['Year'] < 2021) | ((df['Year'] == 2021) & (df['Month'] <= 5)))]  # April 1987 - May 2021
...
for year in predicted_years:
    for month in predicted_months:
        ...
        # Store prediction
        predictions.append([41909, year, month] + predicted_days)  # Fixed station index
...
# Safe file-saving
output_path = r"E:\Thesis\Web App\min_temp\min_temp_41909\predicted_2d_min_temp_41909.xlsx"
