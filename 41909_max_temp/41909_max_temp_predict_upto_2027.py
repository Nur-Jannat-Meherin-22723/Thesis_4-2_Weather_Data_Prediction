...
file_path = r"E:\Thesis\Web App\max_temp\41909_max_temp\2d_ssa_reconstructed_41909_max_temp.xlsx"
...
# Filter data to ensure correct training range (Jan 1987 - Dec 2021)
df_train = df[(df['Year'] > 1986) & (df['Year'] < 2022)]  # 1987 - 2021
...
# Identify the last available month in the dataset (Dec 2021)
last_year = 2021
last_month = 12
...
# Predict future data (Jan 2022 - Dec 2027)
predicted_years = np.arange(2022, 2028)
...
# Safe file-saving
output_path = r"E:\Thesis\Web App\max_temp\41909_max_temp\predicted_2d_max_temp_41909.xlsx"
