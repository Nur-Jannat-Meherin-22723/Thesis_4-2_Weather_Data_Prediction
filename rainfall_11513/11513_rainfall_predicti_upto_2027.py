...
# Load dataset
file_path = r"E:\Thesis\Web App\rainfall\rainfall_11513\2d_ssa_reconstructed_11513_rainfall.xlsx"
...
# 🔹 **Fix: Correct the training range (Jan 1977 - May 2021)**
df_train = df[(df['Year'] > 1976) & ((df['Year'] < 2021) | ((df['Year'] == 2021) & (df['Month'] <= 5)))]  
...
# Safe file-saving
output_path = r"E:\Thesis\Web App\rainfall\rainfall_11513\predicted_rainfall_11513.xlsx"
