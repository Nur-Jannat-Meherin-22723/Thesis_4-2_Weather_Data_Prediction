...
input_file = r"E:\Thesis\Min Temp\11111\min_temp_station_11111.xlsx"
output_file = os.path.join(os.path.dirname(input_file), "outlier_processed_min_temp_station_11111.xlsx")
