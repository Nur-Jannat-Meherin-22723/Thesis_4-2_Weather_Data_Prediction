...
input_file = r"E:\Thesis\Relative Humidity\11111\rh_station_11111.xlsx"
output_file = os.path.join(os.path.dirname(input_file), "outlier_processed_rh_station_11111.xlsx")
