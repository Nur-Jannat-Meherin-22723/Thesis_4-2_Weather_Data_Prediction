...
input_file = r"E:\Thesis\Relative Humidity\11513\svr_rh_11513\2d_ssa_reconstructed_11513_rh.xlsx"
output_file = os.path.join(os.path.dirname(input_file), "normalized_rh_station_11513.xlsx")
