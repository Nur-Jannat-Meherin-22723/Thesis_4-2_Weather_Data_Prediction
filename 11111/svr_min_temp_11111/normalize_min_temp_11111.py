...
input_file = r"E:\Thesis\Min Temp\11111\svr_min_temp_11111\2d_ssa_reconstructed_11111_min_temp.xlsx"
output_file = os.path.join(os.path.dirname(input_file), "normalized_min_temp_station_11111.xlsx")
