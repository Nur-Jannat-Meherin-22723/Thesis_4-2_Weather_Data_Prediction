...
file_path = r"E:\Thesis\Web App\rainfall\rainfall_11111\2d_ssa_reconstructed_11111_rainfall.xlsx"
...
# Filter data to ensure correct training range (Jan 1953 - May 2021)
df_train = df[(df['Year'] > 1952) & ((df['Year'] < 2021) | ((df['Year'] == 2021) & (df['Month'] <= 5)))]  # Jan 1953 - May 2021

# Prepare data for training
X = df_train[day_cols].values  # Features (daily rainfall)
...
for year in predicted_years:
    for month in predicted_months:
        ...
        # Store prediction
        predictions.append([11111, year, month] + predicted_days)  # Fixed station index
...
# Safe file-saving
output_path = r"E:\Thesis\Web App\rainfall\rainfall_11111\predicted_rainfall_11111.xlsx"
