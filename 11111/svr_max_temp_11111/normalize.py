...
input_file = "/home/hp/Downloads/Thesis_4-2_Weather_Data_Prediction-Max-Temp/11111/2d_ssa_reconstructed_11111_max_temp.xlsx"
output_file = os.path.join(os.path.dirname(input_file), "normalized_max_temp_station_11111.xlsx")
