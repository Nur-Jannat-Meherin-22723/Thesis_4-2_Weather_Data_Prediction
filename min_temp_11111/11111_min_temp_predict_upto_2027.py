...
file_path = r"E:\Thesis\Web App\min_temp\min_temp_11111\2d_ssa_reconstructed_11111_min_temp.xlsx"
...
# Filter data to ensure correct training range (Jan 1953 - Aug 2021)
df_train = df[(df['Year'] > 1952) & ((df['Year'] < 2021) | ((df['Year'] == 2021) & (df['Month'] <= 8)))]  # 1953 - Aug 2021
...
# Identify the last available month in the dataset (Aug 2021)
last_year = 2021
last_month = 8
...
# Predict future data (Sep 2021 - Dec 2027)
...
for year in predicted_years:
    for month in predicted_months:
        if year == 2021 and month <= 8:
            continue  # Skip months before September 2021
        ...
        # Store prediction
        predictions.append([11111, year, month] + predicted_days)
...
# Safe file-saving
output_path = r"E:\Thesis\Web App\min_temp\min_temp_11111\predicted_2d_min_temp_11111.xlsx"
